...
class CVRPModel(nn.Module):
    ...
    def one_step_rollout(self, state, cur_dist, cur_theta, xy, norm_demand, eval_type,ins_feature = None):
        ...
        if state.selected_count == 0:  # First Move, depot
            ...
            probs = self.decoder(encoded_last_node, state.load, cur_dist, cur_theta, xy, norm_demand=norm_demand, ninf_mask=state.ninf_mask,ins_feature=ins_feature)
