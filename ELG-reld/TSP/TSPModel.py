...
class TSPModel(nn.Module):
    ...
    def one_step_rollout(self, state, cur_dist, cur_theta, xy, eval_type,scale=None):
        ...
        if state.current_node is None:
            ...
            # shape: (batch, pomo, embedding)
            probs = self.decoder(encoded_last_node, cur_dist=cur_dist, cur_theta=cur_theta, xy=xy, ninf_mask=state.ninf_mask,scale=scale)
